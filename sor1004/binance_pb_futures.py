...
class BinancePBFutures:
    ...
    async def continuous_klines(
        ...
        data = await self._http.get("/fapi/v1/continuousKlines", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def index_price_klines(
        ...
        data = await self._http.get("/fapi/v1/indexPriceKlines", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def mark_price_klines(
        ...
        data = await self._http.get("/fapi/v1/markPriceKlines", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def funding_rate(
        ...
        data = await self._http.get("/fapi/v1/fundingRate", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def ticker_24hr(
        ...
        data = await self._http.get("/fapi/v1/ticker/24hr", params=params, futures=True)
        return data
    ...
    async def ticker_price(
        ...
        data = await self._http.get("/fapi/v1/ticker/price", params=params, futures=True)
        return data
    ...
    async def ticker_book(
        ...
        data = await self._http.get("/fapi/v1/ticker/bookTicker", params=params, futures=True)
        return data
    ...
    async def open_interest(
        ...
        data = await self._http.get("/fapi/v1/openInterest", params=params, futures=True)
        return data
    ...
    async def open_interest_hist(
        ...
        data = await self._http.get("/futures/data/openInterestHist", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def top_long_short_position_ratio(
        ...
        data = await self._http.get("/futures/data/topLongShortPositionRatio", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def top_long_short_account_ratio(
        ...
        data = await self._http.get("/futures/data/topLongShortAccountRatio", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def long_short_ratio(
        ...
        data = await self._http.get("/futures/data/globalLongShortAccountRatio", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def taker_buy_sell_volume(
        ...
        data = await self._http.get("/futures/data/takerBuySellVol", params=params, futures=True)
        return data  # type: ignore[return-value]
    ...
    async def basis(
        ...
        data = await self._http.get("/futures/data/basis", params=params, futures=True)
        return data  # type: ignore[return-value]
