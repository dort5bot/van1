# utils/binance_api/binance_pr_asset.py
"""
...
class AssetClient(BinancePrivateBase):
    ...
    async def get_dust_assets(self) -> Dict[str, Any]:
        """GET /sapi/v1/asset/dust-btc - Get assets that can be converted to BNB (dust assets)."""
        try:
            return await self.circuit_breaker.execute(
                self.http._request, "GET", "/sapi/v1/asset/dust-btc", signed=True
            )
        except Exception as e:
            logger.exception("Error getting dust assets")
            raise BinanceAPIError("GET /sapi/v1/asset/dust-btc failed", e)

    # ----------------------------- DEPOSIT  -----------------------------

    async def get_deposit_address_list(self, coin: Optional[str] = None) -> List[Dict[str, Any]]:
        """GET /sapi/v1/capital/deposit/address/list - Get all deposit addresses."""
        try:
            params = {}
            if coin:
                params["coin"] = coin.upper()
            return await self.circuit_breaker.execute(
                self.http._request, "GET", "/sapi/v1/capital/deposit/address/list", 
                params=params, signed=True
            )
        except Exception as e:
            logger.exception("Error getting deposit address list")
            raise BinanceAPIError("GET /sapi/v1/capital/deposit/address/list failed", e)

    # ----------------------------- WITHDRAW  -----------------------------

    async def get_withdraw_details(self, withdraw_id: Optional[str] = None, 
                                  client_withdraw_id: Optional[str] = None) -> Dict[str, Any]:
        """GET /sapi/v1/capital/withdraw/detail - Get withdraw details."""
        try:
            params = {}
            if withdraw_id:
                params["withdrawId"] = withdraw_id
            if client_withdraw_id:
                params["clientWithdrawId"] = client_withdraw_id
                
            return await self.circuit_breaker.execute(
                self.http._request, "GET", "/sapi/v1/capital/withdraw/detail", 
                params=params, signed=True
            )
        except Exception as e:
            logger.exception("Error getting withdraw details")
            raise BinanceAPIError("GET /sapi/v1/capital/withdraw/detail failed", e)

    async def get_deposit_details(self, deposit_id: Optional[str] = None,
                                 tx_id: Optional[str] = None) -> Dict[str, Any]:
        """GET /sapi/v1/capital/deposit/detail - Get deposit details."""
        try:
            params = {}
            if deposit_id:
            ...
            return await self.circuit_breaker.execute(
                self.http._request, "GET", "/sapi/v1/capital/deposit/detail", 
                params=params, signed=True
            )
        except Exception as e:
            logger.exception("Error getting deposit details")
            raise BinanceAPIError("GET /sapi/v1/capital/deposit/detail failed", e)
    
    # utils/binance/binance_pr_asset.py - AssetClient'a eklenen endpoint'ler
    async def get_asset_ledger(
        ...
        """GET /sapi/v1/asset/ledger - Get asset ledger (transfer history)."""
        try:
            params = {"limit": limit}
            if asset:
                params["asset"] = asset.upper()
            ...
            return await self.circuit_breaker.execute(
                self.http._request, "GET", "/sapi/v1/asset/ledger", 
                params=params, signed=True
            )
        except Exception as e:
            logger.exception("Error getting asset ledger")
            raise BinanceAPIError("GET /sapi/v1/asset/ledger failed", e)

    async def get_auto_conversion_status(self, asset: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return await self.circuit_breaker.execute(
                self.http._request, "GET", "/sapi/v1/asset/auto-conversion", 
                params=params, signed=True
            )
        except Exception as e:
            logger.exception("Error getting auto-conversion status")
            raise BinanceAPIError("GET /sapi/v1/asset/auto-conversion failed", e)

    async def set_auto_conversion(self, asset: str, enable: bool) -> Dict[str, Any]:
        """POST /sapi/v1/asset/auto-conversion - Set auto-conversion status."""
        try:
            params = {
                "asset": asset.upper(),
            ...
            return await self.circuit_breaker.execute(
                self.http._request, "POST", "/sapi/v1/asset/auto-conversion", 
                params=params, signed=True
            )
        except Exception as e:
            logger.exception("Error setting auto-conversion")
            raise BinanceAPIError("POST /sapi/v1/asset/auto-conversion failed", e)
